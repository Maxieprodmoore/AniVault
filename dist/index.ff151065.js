...
})({"3pRhz":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "4237eedcff151065";
"use strict";
...
/*======================Product Filtering================*/ filterSelection("all");
function filterSelection(c) {
    var x, i;
    /* Get products -------------------------*/ x = document.getElementsByClassName("productDiv");
    if (c == "all") c = "";
...
/* Show Elements---------------------*/ function sectionAddClass(element, name) {
    var i, arr1, arr2;
    arr1 = element.className.split(" ");
    arr2 = name.split(" ");
    for(i = 0; i < arr2.length; i++)if (arr1.indexOf(arr2[i]) == -1) element.className += " " + arr2[i];
}
/* Hide elements that aren't selected---------------------*/ function sectionRemoveClass(element, name) {
    var i, arr1, arr2;
    arr1 = element.className.split(" ");
    arr2 = name.split(" ");
...
/*Add "active" Class to current control button (Highlight it)---------------------*/ var productBtnContainer = document.getElementById("productFilter");
...
//# sourceMappingURL=index.ff151065.js.map
